...
// gather-indexed, and the filters/delays are all recurrence-bound. What is left is the
// bulk block clears/copies and the multiply-free block scans, which is what this covers.
//
...
// PIE-accelerated on ESP32-S3, libc bzero/bcopy everywhere else. Safe in float builds
